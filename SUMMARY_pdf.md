...
* [概要](overview.md)
* [セットアップ](SetUp.md)
* [v1.2.0リリースノート](v1_2update.md)
* [v1.0から1.1へのアップデートガイド](v1_1update.md)
---
* [主な操作方法](MainOperation.md)
* [ファイルビューの操作](FileView.md)
* [ファイルをインデックスに登録する](IndexRegister.md)
* [コンフィグファイルを作成する](ConfigFile.md)
---
* [AIを使う](UseAI.md)
* [AIに質問する](AskToAI.md)
...
* [議事録を取る](Recording.md)
* [音声入力を利用する場合](VoiceInput.md)
---
* [ローカルLLMの設定](LocalLLM.md)
* [ベンチマーク機能](Benchmark.md)
---
* [セキュアな環境構築](Security.md)
* [カスタムLLMの設定](CustomLLM.md)
* [LMスタジオを使用したカスタムLLM構築](CustomLLM_LMstudio.md)
